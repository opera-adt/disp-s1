...
cp -r "${full_dir}/dynamic_ancillary_files/troposphere_files/" "$new_dir/dynamic_ancillary_files/troposphere_files/"
cp -r "${full_dir}/dynamic_ancillary_files/ionosphere_files/" "$new_dir/dynamic_ancillary_files/ionosphere_files/"
